...
^https?:\/\/api\.revenuecat\.com\/v1\/(receipts|subscribers\/\$RCAnonymousID%3A\w{32})$ url script-response-body https://raw.githubusercontent.com/jane77u/Shining-file/main/Quantumult-X/scripts/fileball.js

^https:\/\/app-measurement\.com\/config\/app\/1?(.*?)*$ url reject

projects = type=http-response,pattern=^https://firebaseremoteconfig.googleapis.com/v1/projects/filebox-ac299/.*,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/jane77u/Shining-file/main/Quantumult-X/scripts/projects.js
fileball = type=http-response,pattern=^https?:\/\/api\.revenuecat\.com\/v1\/(receipts|subscribers\/\$RCAnonymousID%3A\w{32})$,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/jane77u/Shining-file/main/Quantumult-X/scripts/fileball.js
